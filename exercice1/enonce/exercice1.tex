\documentclass{exam}
    ...
    \begin{questions}
        ...
        \input{./source/E1AlloMonde.tex}
        \titledquestion{Horaire}
        \input{./source/E2Horaire.tex}          
        \titledquestion{Nombre double}
        \input{./source/E3DoubleDuNombre.tex}
        \titledquestion{Nombre carré}
        \input{./source/E4CarreDuNombre.tex}
        \titledquestion{Coûts d’achats avec taxes}
        \input{./source/E5CoutAvecTaxes.tex}
        \titledquestion{Nom et prénom}
        \input{./source/E6NomEtPrenom.tex}
        \titledquestion{Multiplication de deux nombres}
        \input{./source/E7MultiplieDeuxNombres.tex}
        \titledquestion{Positif, négatif ou nul}
        \input{./source/E8PositifNegatifNul.tex}
        \titledquestion{Minimum}
        \input{./source/E9MinimumEntreDeux.tex}
        \titledquestion{Quadrant cartésien}
        \input{./source/E10QuadrantCartesien.tex}
        \titledquestion{IMC}
        \input{./source/E11IMC.tex}
        \titledquestion{Plus petit de trois}
        \input{./source/E12MinimumEntreTrois.tex}
        \titledquestion{Menu}
        \input{./source/E13Menu.tex}
