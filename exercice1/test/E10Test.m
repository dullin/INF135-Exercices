...
diary('off')
text = fileread('diary');
expected = ['( 3 , 5 ) est dans le quadrant : I' char(10)];
...
diary('off')
text = fileread('diary');
expected = ['( -12 , 7 ) est dans le quadrant : II' char(10)];
cmp = strcmplazy(text,expected);
...
diary('off')
text = fileread('diary');
expected = ['( -5.5 , -9 ) est dans le quadrant : III' char(10)];
cmp = strcmplazy(text,expected);
...
diary('off')
text = fileread('diary');
expected = ['( 4, -12 ) est dans le quadrant : IV' char(10)];
cmp = strcmplazy(text,expected);
